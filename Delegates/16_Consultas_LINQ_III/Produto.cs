namespace _16_Consultas_LINQ_III;
...
public class Produto
{
    ...
    public static List<Produto> GetProdutos()
    {
        List<Produto> produtos = new()
        {
            ...
            new Produto {Id = 6, Name = "Macbook Pro m3", Preco = 5499.99m, Estoque = 6, Categoria = "Eletrônicos"},
            ...
            new Produto {Id = 10, Name = "Smart TV", Preco = 3999.99m, Estoque = 4, Categoria = "Eletrônicos"}
        };
        return produtos;
    }
}